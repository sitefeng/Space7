...
//        AboutSceneViewController* aboutViewController = [[AboutSceneViewController alloc] initWithNibName:@"AboutSceneViewController" bundle:nil];
        ...
        dText.text = @"Well, hi there, commander!\nWe are now lost in a galaxy far far away from Earth. We have an urgent objective to find our way back to the Milky Way Galaxy. During our adventure, we'll explore gorgeous galaxies while trying to avoid evil alien spaceships.\nI hope you'll enjoy!\n\nSincerely,\niOS game devs\n\n-----\n\nPlease email us at technochimera@gmail.com if you have any questions or suggestions about the game. If you like this game, please spread the word and share this on Facebook. \n\nThank you for your support!\n\nOctober 5th, 2013\n\n\n-----\n\nDetails\n\n    This iOS game was made by Si Te Feng and Karim Kawambwa during the 30 hour, 2013 hackMIT. As the authors of the game, we would like to thank very helpful mentors at \"Make Games With Us\" for talking the time to solve some bugs in the process. Also we want to thank www.designbolts.com as well as http://www.freesfx.co.uk for providing to us some very good sound effects to use in the game. Also thanks goes out to subversion.bandcamp.com for its awesome background soundtrack. Last but not least, thank you for supporting the game.";
